...
<body>
  ...
  <!--Tudo modificado para meche na nova versao dos eventos -->
        <img src="imagens/Evento Caxias Shopping.png" alt="IMPACT DALLAS">
        <div class="buy-ticket-container">
           
        </div>
        <div class="evento-titulo">

            <h3>   <p style="text-align: left;">Mix festival Caxias </p></h3>
             
        </div>
        <div class="evento-Local">
            <h4>   <p style="text-align: left;"> Caxias Shopping - Duque de Caxias - Rio de Janeiro  </p></h4>
        
        </div>
      <div class="evento-dadosInfo">
        <h4> <p style="text-align: left;">terça: 29/09/23 | horario: 11:00</p></h4>
