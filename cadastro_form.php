     ...
     <div class="radio1"> 
      ...
      <div id="inputs">
        ...
        <form method="POST" action="">
          ...
          <input style="width: 220px;" type="text" name="usuario" class="caixa-dados" placeholder="Insira o seu nome de usuário..." required>

          <div id="campo-sobrenome">
            <h4>Nome completo</h4>
            <i id="icone-user" class="fa-solid fa-user" style="color: #bbbbbb;"></i>
            <input style="width: 221px;" type="text" name="nome" id="sobrenome" class="caixa-dados"
              placeholder="Insira o seu nome completo..." required>
          </div>

          <h4>E-mail</h4>
          <i id="icone-email" class="fa-solid fa-envelope" style="color: #bbbbbb;"></i>
          <input type="email" name="email" class="caixa-dados" placeholder="Insira o seu e-mail..." required>

          <h4>Telefone</h4>
          <i id="icone-telefone" class="fa-solid fa-phone" style="color: #bbbbbb;"></i>
          <input type="tel" name="telefone" class="caixa-dados" placeholder="(00) 0000-0000" required>

          <h4>Senha</h4>
          <i id="icone-cadeado" class="fa-solid fa-lock" style="color: #bbbbbb;"></i>
          <input type="password" name="senha" class="caixa-dados" placeholder="Insira a sua senha..." required>
          <br><br>
