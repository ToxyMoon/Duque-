...
<body>
  ...
  <!--Tudo modificado para meche na nova versao dos eventos -->
        <img src="imagens/event- Uma dose.png" alt="IMPACT DALLAS">
        ...
        <div class="evento-titulo">
            ...
            <h3>   <p style="text-align: left;">Uma Dose de Caxias </p></h3>
      ...
      <div class="evento-dadosInfo">
        <h4> <p style="text-align: left;">terça: 9/11/23 | horario: 18:50</p></h4>
...
E o chocalho fatídico dos ossos!
 ...
 <br>
        <div class="mapa-da-google">
            ...
            <p style="text-align: left;">Teatro de Caxias</p>
