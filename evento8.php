...
<head>
    <title>ECS | ESL Impact S3 Dallas Finals</title>
...
<body>
  ...
  <!--Tudo modificado para meche na nova versao dos eventos -->
        <img src="imagens/FluminenseGiga.png" alt="IMPACT DALLAS">
        <div class="buy-ticket-container">
           
        </div>
        <div class="evento-titulo">
            <h4> <p style="text-align: left;">Fluminense</p></h4>
        </div>
        <div class="evento-Local">
            <h4> <p style="text-align: left;">Nilton Santos  - Praça Mauá, 1, Rio de Janeiro - Rio de Janeiro</p></h4>
        </div>
      <div class="evento-dadosInfo">
        <h4> <p style="text-align: left;">Sabado: 07/10/23 | horario: 12:00 </p></h4>
        ...
        <br>
            Preço : 00,00
            <hr>
            <button class="buy-ticket-button">INSCREVER-SE NO EVENTO</button>
        </div>
    <br>
<hr>
<br>
 ...
 <!--Mapa do Google-->
     <div class="mapa-da-google">
        <h4> <p style="text-align: left;">Localização</p></h4>
         ...
         <p style="text-align: left;">Nilton Santos</p>
        ...
        width="80%" height="390px" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p>
</div>
