...
<body>
  ...
  <!--Tudo modificado para meche na nova versao dos eventos -->
        <img src="imagens/event-game.jpeg" alt="IMPACT DALLAS">
        <div class="buy-ticket-container">
           
        </div>
        <div class="evento-titulo">

            <h3>   <p style="text-align: left;">Jogo de Mesa         </p></h3>
             
        </div>
        <div class="evento-Local">
            <h4>   <p style="text-align: left;">Biblioteca de  Caxias - Duque de Caxias - Rio de Janeiro  </p></h4>
        
        </div>
      <div class="evento-dadosInfo">
        <h4> <p style="text-align: left;">quartas e quintas | horario: 18:50</p></h4>
...
E o chocalho fatídico dos ossos!
 ...
 <br>
        <div class="mapa-da-google">
            ...
            <p style="text-align: left;">Biblioteca de Caxias </p>
