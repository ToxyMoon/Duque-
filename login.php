...
<body>
  ...
  <div id="fundo-login">
    ...
    <div id="container-texto">
      ...
      <!-- ícone X do Login-->
      <div id="close-icon" onclick="window.location.href='index.html'">
      ...
      <div id="inputs">
        ...
        <form method="post">
          ...
          <input type="text" id="username" placeholder="Insira o seu nome de usuário...">

          <h4>E-mail</h4>
          <i id="icone-email" class="fa-solid fa-envelope" style="color: #bbbbbb;"></i>
          <input type="email" id="email" placeholder="Insira o seu e-mail...">
          ...
          <i id="icone-olho" class="bi bi-eye-fill" style="color: #bbbbbb;"></i>
          <br>

          <button type="submit" id="btn-enviar">ENTRAR</button> <!-- Botão de Entrar (login)-->
